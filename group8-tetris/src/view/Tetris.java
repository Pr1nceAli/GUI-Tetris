...
public final class Tetris extends JPanel implements PropertyChangeListener, KeyListener {
     ...
     */
    private static final Timer TIMER = new Timer(STEP_INTERVAL, action -> BOARD.step());
    ...
    /**
     *  Assigning key for movement left.
     * @param theKeyCode of type int.
     * @return Boolean
     */
    ...
    /**
     *  Assigning key for movement right.
     * @param theKeyCode of type int.
     * @return Boolean
     */
    ...
    /**
     *  Assigning key for movement down.
     * @param theKeyCode of type int.
     * @return Boolean
     */
